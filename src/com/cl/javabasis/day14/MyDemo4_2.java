 ...
 */
public class MyDemo4_2 {
	public static void main(String[] args) {
		Studen3 studen=new Studen3();
		Producer3 producer2=new Producer3(studen);
		Customer3 customer2=new Customer3(studen);
...
class Producer3 implements Runnable{
	private Studen3 studen;
	
	public Producer3(Studen3 studen) {
		this.studen = studen;
	}
...
class Customer3 implements Runnable{
	private Studen3 studen;
	public Customer3(Studen3 studen) {
		this.studen = studen;
	}
	public void run() {
		while(true){
